...
class _CommonProblemState extends State<CommonProblem> {
  List problem = [
    ...
    },
    {
      'title': '2.关于押金',
      'children': [
        '* 押金：租赁商品物权归属小公公，防止用户恶意损害商品，需要先收取押金作为担保。',
    ...
    },
    {
      'title': '3.关于京东分期代扣',
      'children': [
        '* 签约：下单支付时需要您先签约免密代扣，同意小公公进行分期款项的代扣。如果您已签约，在后期下单时可不用再签。',
    ...
    },
    {
      'title': '4.关于退换货、维修等售后',
      'children': [
        '* 退换货：退换货申请请联系客服。因商品质量或错发漏发导致的退换货由小公公承担运费，因您个人原因问题导致的退换货将由您承担退回运费，如果已经使用中将会收取一定的违约金',
        '* 维修保养：因非人为损坏造成的商品故障，寄回或者上门维修的所有费用由小公公承担；因人为损坏产生的维修费用和物流费用需由您支付。一切商品使用期间产生的保养类服务费用（如更换滤网、滤芯等服务）由您承担。'
      ]
    },
    {
      'title': '5.关于逾期支付、逾期归还',
